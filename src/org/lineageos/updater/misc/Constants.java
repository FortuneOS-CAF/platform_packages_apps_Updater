...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "org.fortune.revision";
    public static final String PROP_DEVICE = "org.fortune.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "org.fortune.build.type";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "fortune.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "fortune.updater.uri";
